...
public class MQSendResult implements Serializable{
	 ...
	 * sendResult对象
	 */
	private org.apache.rocketmq.client.producer.SendResult sendResult;
	...
	public org.apache.rocketmq.client.producer.SendResult getSendResult() {
		return sendResult;
	}
	public void setSendResult(org.apache.rocketmq.client.producer.SendResult sendResult) {
		this.sendResult = sendResult;
	}
