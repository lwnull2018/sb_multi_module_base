...
public class ConsumerConfiguration {
    ...
    @Autowired
    private ConsumeListenerProcessor mqMessageListenerProcessor;
    ...
    public DefaultMQPushConsumer getRocketMQConsumer() throws RocketMQException {
        ...
        try {
            ...
            consumer.start();
            LOGGER.info("consumer is start !!! groupName:{%s},topics:{%s},namesrvAddr:{%s}",groupName,topics,namesrvAddr);
        }catch (MQClientException e){
            LOGGER.error("consumer is start !!! groupName:{%s},topics:{%s},namesrvAddr:{%s}",groupName,topics,namesrvAddr,e);
